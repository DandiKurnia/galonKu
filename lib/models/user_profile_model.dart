...
//
//     final userPorfileModel = userPorfileModelFromJson(jsonString);

import 'dart:convert';

UserPorfileModel userPorfileModelFromJson(String str) =>
    UserPorfileModel.fromJson(json.decode(str));

String userPorfileModelToJson(UserPorfileModel data) =>
    json.encode(data.toJson());

class UserPorfileModel {
  String accessToken;
  User user;

  UserPorfileModel({required this.accessToken, required this.user});

  factory UserPorfileModel.fromJson(Map<String, dynamic> json) =>
      UserPorfileModel(
